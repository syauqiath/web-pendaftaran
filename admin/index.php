        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="index.php?halaman=materi"><i class="fa fa-cube fa-2x"></i> Materi</a></li>
                    <li><a href="index.php?halaman=mahasiswa"><i class="fa fa-tags fa-2x"></i> Mahasiswa</a></li>
            ...
            <div id="page-inner">
                ...
                if (isset($_GET['halaman'])) {
                    if ($_GET['halaman'] == "mahasiswa") {
                        ...
                        include 'materi.php';
                    } elseif ($_GET['halaman'] == "tambahmateri") {
                        include 'tambahmateri.php';
                    } elseif ($_GET['halaman'] == "hapusmateri") {
                        include 'hapusmateri.php';
                    } elseif ($_GET['halaman'] == "editmateri") {
